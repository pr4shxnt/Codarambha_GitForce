  ...
  return (
    <div className="min-h-screen relative bg-white text-gray-900">
      ...
      <div className="min-h-[50vh] relative">
        <div className="absolute h-[75%] w-full inset-0 bg-[linear-gradient(45deg,transparent_25%,rgba(0,0,0,0.03)_50%,transparent_75%)] bg-[length:60px_60px]" />

        <div className="relative z-10 max-w-5xl mx-auto px-6 pt-40 py-20 space-y-20">
          {/* Header */}
      ...
      {/* Extra Info */}
      <section className="text-center w-full space-y-4 py-20">
        <h2 className="text-4xl font-bold text-black">Why Choose Our App?</h2>
        <p className="text-gray-600 max-w-2xl mx-auto">
